...
export function DataTable<TData, TValue>({
  ...
  const [mutationData, setMutationData] = React.useState<Drop[]>([]);
  ...
  useEffect(() => {
    setMutationData(data as unknown as Drop[]);
  }, [data]);
  ...
  return (
    <div className="space-y-4">
      ...
      {!!selectedIds.length && (
        <DeleteDropsButton idArray={selectedIds}>
